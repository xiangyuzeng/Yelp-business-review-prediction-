...
model = lm(stars ~ X1 + X2 + X3 + X4 + X5 + X7 + X8 + X9 + X10 + X11 + X12 + X14 + X15 + X16 + X17 + X18 + X19 + X20 + X21 + X22 + X23 + X24 + X25 + X26 + X27 + X29 + X30 + X31 + X32 + X33 + X35 + X36 + X37 + X38 + X39 + X40 + X41 + X42 + X43 + X44 + X46 + X47 + X48 + X50 + X51 + X52 + X53 + X54 + X55 + X56 + X58 + X59 + X61 + X62 + X63 + X64 + X65 + X66 + X67 + X68 + X69 + X71 + X72 + X74 + X75 + X77 + X78 + X80 + X81 + X82 + X85 + X86 + X87 + X90 + X91 + X92 + X93 + X94 + X95 + X96 + X98 + X101 + X38:X94 + X38:X98 + X94:X98 + X71:X75 + X52:X94 + X36:X94 + X36:X52 + X52:X75 + X77:X94 + X33:X77 + X33:X95 + X77:X95 + X36:X52:X94 + X33:X94:X95 + X33:X77:X95 + X33:X77:X94:X95, data = Data)
